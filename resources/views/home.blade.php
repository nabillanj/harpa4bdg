...
<div id="con">
    <div id="slider">
        <figure>
            <img src="{{ asset('assets') }}/img/slider/1.jpg" alt="FPA XV ITB">
            <img src="{{ asset('assets') }}/img/slider/5.jpg">
            <img src="{{ asset('assets') }}/img/slider/3.jpg">
            <img src="{{ asset('assets') }}/img/slider/4.jpg">
...
<center>
    <div class="welcome">
            <img src="{{ asset('assets') }}/img/welcome_bg.png" align="center" style="width:95%; height: 3px">
        <img class="sayap1" src="{{ asset('assets') }}/img/sayap.png" alt="sayap" >
        <p class="text1" align="center"><b>HARMONI PADUAN ANGKLUNG</b></p>
        <p class="text2">SMK Negeri 4 Bandung</p>
        <img class="sayap" src="{{ asset('assets') }}/img/sayap.png" alt="sayap" >
            <img src="{{ asset('assets') }}/img/welcome_bg.png" align="center" style="width:95%; height: 3px">
    </div>
</center>
...
<div class="fixed-group">
    <div id="left">
        <div class="history">
            <center><img src="{{ asset('assets') }}/img/history.png" alt="prestasi"></center>
        </div>
    ...
    <div id="right">
        <div class="prestasi">
            <center><img src="{{ asset('assets') }}/img/prestasi.png" alt="prestasi"></center>
        </div>
    ...
    <center>
        <img src="{{ asset('assets') }}/img/welcome_bg.png" align="center" style="width:90%; height: 3px">
    </center>
</div>
...
<div class="info-ketua">
    <div id="topdes">
        ...
        <center><img src="{{ asset('assets') }}/img/welcome_bg.png" style="width:15%; height: 3px"></center>
    </div>
            <div id="objek">
                <img src="{{ asset('assets') }}/img/galeri/5.jpg" class="gambar1" />
                    <div class="ket">Perpisahan 2016</div>
            </div>
            <div id="objek">
                <img src="{{ asset('assets') }}/img/galeri/11.jpg" class="gambar2" />
                <div class="ket">FPA XV</div>
            </div>
            <div id="objek">
                <img src="{{ asset('assets') }}/img/galeri/12.jpg" class="gambar3" />
                <div class="ket">THINK 2</div>
            </div>
            <div id="objek">
                <img src="{{ asset('assets') }}/img/galeri/14.jpg" class="gambar3" />
                <div class="ket">THINK 2</div>
            </div>
            <div id="objek">
                <img src="{{ asset('assets') }}/img/galeri/27.jpg" class="gambar3" />
                <div class="ket">Government Art Show</div>
            </div>
            <div id="objek">
                <img src="{{ asset('assets') }}/img/galeri/38.jpg" class="gambar3" />
                <div class="ket">Gladi FPA XV</div>
            </div>
            <div id="objek">
                <img src="{{ asset('assets') }}/img/galeri/39.jpg" class="gambar3" />
                <div class="ket">Gladi FPA XV</div>
            </div>
            <div id="objek">
                <img src="{{ asset('assets') }}/img/galeri/40.png" class="gambar3" />
